...
{
    public partial class FacilitatorLogin : System.Web.UI.Page
    {
        ...
        protected void btnLogIn_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                String stmt = "SELECT COUNT(1)  FROM Assessor_Security WHERE UserName = @UserName  AND Password = @Password";

...
{
    public partial class ModeratorLogin : System.Web.UI.Page
    {
        ...
        protected void btnLogIn_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                String stmt = "SELECT COUNT(1)  FROM Moderator_Security WHERE UserName = @UserName  AND Password = @Password";
